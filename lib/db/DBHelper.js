...
DBHelper.Server = new Helper("servers", "name")
DBHelper.Group  = new Helper("groups", "name")
DBHelper.Key    = new Helper("keys", "name")
DBHelper.Script = new Helper("scripts", "id")
DBHelper.Config = new Helper("configs", "key")
